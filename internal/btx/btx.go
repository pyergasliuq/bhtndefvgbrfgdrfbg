...
func (e *Encoder) EncodeImage(imgData []byte, quality Quality, speed Speed) ([]byte, error) {
        ...
        // 2. Pick block size from quality.
        blockW, blockH := pickBlockSize(img, quality)
...
// pickBlockSize returns the ASTC block dimensions for the given quality.
