...
var AllCommands = []CommandHelp{
        ...
        // ── AI функции ──────────────────────────────────────────────────────────
        {
                Name: "/aitimecyc", Short: "AI TimeCycle",
                Usage: "/aitimecyc <описание>", Description: "Генерирует timecyc.json по текстовому описанию атмосферы.",
                Examples: []string{"/aitimecyc закат с алыми облаками", "/aitimecyc тёмная ночь с яркими звёздами"},
                ProTip: "Опишите атмосферу подробно — AI подберет цвета неба, облаков и солнца.",
        },
        {
                Name: "/aicolor", Short: "AI цвет",
                Usage: "/aicolor <описание>", Description: "Подбирает HEX-цвет по текстовому описанию.",
                Examples: []string{"/aicolor свет от луны", "/aicolor тёплый закатный оранжевый"},
        },
        {
                Name: "/imgdescribe", Short: "AI описание картинки",
                Usage: "Отправить изображение с подписью /imgdescribe", Description: "AI анализирует изображение и описывает его словами.",
                Examples: []string{"Отправить PNG/JPG с подписью /imgdescribe"},
        },
        {
                Name: "/img2prompt", Short: "AI промпт из картинки",
                Usage: "Отправить изображение с подписью /img2prompt", Description: "Анализирует изображение и генерирует промпт для Stable Diffusion.",
                Examples: []string{"Отправить PNG/JPG с подписью /img2prompt"},
                ProTip: "Используй сгенерированный промпт в Stable Diffusion для создания похожих изображений.",
        },
}
...
func (b *Bot) showHelpMenu(c *middleware.Ctx) {
        ...
        categories := []struct {
         ...
         cmds []CommandHelp
                ...
                {"🤖 AI функции", filterByPrefix([]string{"/aitimecyc", "/aicolor", "/imgdescribe", "/img2prompt"})},
        }
