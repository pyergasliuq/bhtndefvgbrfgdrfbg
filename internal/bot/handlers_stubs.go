...
//
// Stub implementations for handlers NOT YET ported. Each returns a "feature
// not yet implemented" message so the bot compiles and runs end-to-end.
//
// Most handlers are now implemented in handlers_real.go. Only admin panel
// submenus remain as stubs.
package bot
...
// ── Admin callbacks (submenus still as stubs) ─────────────────────────────

func (b *Bot) cbAdminCleanup(c *middleware.Ctx)      { b.notYetImplemented(c, "adm_cleanup") }
func (b *Bot) cbAdminBans(c *middleware.Ctx)         { b.notYetImplemented(c, "adm_bans_list") }
func (b *Bot) cbAdminChannels(c *middleware.Ctx)     { b.notYetImplemented(c, "adm_channels") }
func (b *Bot) cbAdminBroadcast(c *middleware.Ctx)    { b.notYetImplemented(c, "adm_broadcast") }
func (b *Bot) cbAdminGiveSubPanel(c *middleware.Ctx) { b.notYetImplemented(c, "adm_givesub_panel") }
func (b *Bot) cbAdminRoles(c *middleware.Ctx)        { b.notYetImplemented(c, "adm_roles") }
func (b *Bot) cbAdminRoleLog(c *middleware.Ctx)      { b.notYetImplemented(c, "adm_role_log") }
func (b *Bot) cbAdminStaffStats(c *middleware.Ctx)   { b.notYetImplemented(c, "adm_staff_stats") }
func (b *Bot) cbAdminPollsMenu(c *middleware.Ctx)    { b.notYetImplemented(c, "adm_polls_menu") }
func (b *Bot) cbAdminPrankMenu(c *middleware.Ctx)    { b.notYetImplemented(c, "adm_prank_menu") }
func (b *Bot) cbAdminReviews(c *middleware.Ctx)      { b.notYetImplemented(c, "adm_reviews") }
func (b *Bot) cbAdminTickets(c *middleware.Ctx)      { b.notYetImplemented(c, "adm_tickets") }
func (b *Bot) cbAdminPurchases(c *middleware.Ctx)    { b.notYetImplemented(c, "adm_purchases") }
func (b *Bot) cbAdminRefStats(c *middleware.Ctx)     { b.notYetImplemented(c, "adm_ref_stats") }
func (b *Bot) cbAdminPromos(c *middleware.Ctx)       { b.notYetImplemented(c, "adm_promos") }
func (b *Bot) cbAdminCharts(c *middleware.Ctx)       { b.notYetImplemented(c, "adm_charts") }
func (b *Bot) cbAdminCommandsList(c *middleware.Ctx) { b.notYetImplemented(c, "adm_commands_list") }
